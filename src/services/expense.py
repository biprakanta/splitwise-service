...
from ..data.db_interactions import insert_expense, get_expense_by_user_id
from ..data.schema import ExpenseCreate
...
async def list_expenses(
    ...
    start_date: str = Query(
        description="Input Format: YYYY-MM-DD or YYYY-MM-DDTHH:mm:ss.SSS"
    ),
    end_date: str = Query(
        description="Input Format: YYYY-MM-DD or YYYY-MM-DDTHH:mm:ss.SSS"
    ),
):
    return get_expense_by_user_id(db, user_id, start_date, end_date)
