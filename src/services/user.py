...
from ..data.db_interactions import create_user, get_user_by_mobile
from ..data.schema import UserData
...
@router.get("/user")
async def get_user(mobile: int, db: Session = Depends(get_db)):
